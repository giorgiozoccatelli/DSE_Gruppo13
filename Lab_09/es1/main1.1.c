	  ...
	  if (LL_ADC_IsActiveFlag_EOCS(ADC1))
	   {
		...
		CompareUpdate = round(5 + LL_ADC_REG_ReadConversionData8(ADC1));
	  ...
	  else
	   {
		...
		LL_DBGMCU_APB1_GRP1_FreezePeriph(LL_DBGMCU_APB1_GRP1_TIM3_STOP);
		CompareUpdate = LL_TIM_OC_GetCompareCH1(TIM3);
		LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_TIM3_STOP);
	   }
   }
		   /* USER CODE END 3 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_ResetOutputPin(PA10_GPIO_Port, PA10_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(PA10_GPIO_Port, &GPIO_InitStruct);
